...
/* pour récuperer seulement une des valeurs on utilisera (list[3]) dans la liste*/
...
document.getElementById("maitre").innerText= " gegrttg " /*******  permet de rajouter le texte dans l'ID  ************/
